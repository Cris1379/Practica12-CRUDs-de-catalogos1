...
class DetalleComprasManager(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Gestión de Detalle de Compras")
        self.data = []
        self.initUI()
    ...
    def initUI(self):
        ...
        fields = ["id_compra", "id_articulo"]
        form_group = QGroupBox("Formulario de Detalle Compras")
